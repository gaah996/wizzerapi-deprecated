...
<div class="content">
    <p>Temos alguém interessado no seu imóvel na {{$reference}} - {{$referenceLine2}}</p>
    <br>
    <p>Os dados de contato que temos para você entrar em contato são:</p>
    <p><strong>Nome: </strong>{{$name}}</p>
    <p><strong>Telefone: </strong>{{$phone}}</p>
    <p><strong>E-mail: </strong>{{$email}}</p>
    <br>
    <p><strong>Mensagem: </strong>{{$messages}}</p>
</div>
<div class="footer">
    <div class="signature">
        <p>Abraços,</p>
