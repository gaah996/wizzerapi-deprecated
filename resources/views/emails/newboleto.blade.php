...
<div class="content">
    <p>Seu último pagamento irá vencer em 7 dias, por isso geramos o próximo boleto pra você.</p>
    <p>Você pode baixar ele <a href="{{$paymentLink}}">clicando aqui</a>.</p>
    <br>
    <p>Pagando ele até a data de vencimento você continua usando a Wizzer e fazendo bons negócios!</p>
</div>
<div class="footer">
    <div class="signature">
        <p>Abraços,</p>
