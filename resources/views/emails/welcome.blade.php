...
<body>
    ...
    <div class="content">
        <p>Obrigado por se cadastrar na Wizzer.</p>
        <p>Estamos empolgados para ajudar você a vender ou alugar seus imóveis.</p>
        <p>Faça seu login e escolha o plano que mais se encaixa no seu perfil.</p>
        <br>
        <p>Esperamos você em nosso site!</p>
    </div>
    <div class="footer">
        <div class="signature">
            <p>Abraços,</p>
